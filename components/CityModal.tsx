...
export default function CityModal({
  ...
  return (
    ...
    >
      <div
        className="bg-[#171726] w-full max-w-md rounded-3xl p-6 max-h-[70dvh] flex flex-col min-h-0"
      ...
      >
        ...
        <div className="space-y-2 overflow-y-auto flex-1 min-h-0 mb-4">
          {filtered.map((city) => (
            <button
              key={city}
              onClick={() => {
        ...
        <div className="flex items-center gap-2 bg-[#222233] border border-white/10 focus-within:border-violet-500 rounded-xl px-4 py-3 shrink-0 transition">
